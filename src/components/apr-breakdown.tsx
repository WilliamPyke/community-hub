  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="font-mono text-sm font-semibold text-emerald-400 hover:text-emerald-300 transition-colors cursor-pointer"
      >
        {apr.toFixed(2)}%
        {breakdown.length > 1 && (
      ...
      {open && (
        <div
          className="absolute z-50 top-full mt-2 left-0 w-56 bg-zinc-900 border border-zinc-700/60 rounded-xl shadow-2xl shadow-black/40 p-4"
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
          }}
